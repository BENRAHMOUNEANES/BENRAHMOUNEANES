...
|------|-----------------|
| 📱 **Flutter Developer** | Building and maintaining cross-platform mobile applications |
| ⚙️ **Backend Gatekeeper** | Managing API architecture, security, and backend infrastructure |
...
| 💬 **Chat App** | Real-time messaging app with live updates | Flutter · Firebase |
| ☀️ **Weather App** | Live weather display using public APIs | Flutter |
| 🛒 **Walmart Scraper** | Python scraper for product data extraction | Python · Requests |
